...
const runGit = (cwd, argumentsList) => runFile("git", argumentsList, { cwd });
...
test("renders one exact public tree with revision-parity and line anchors", async () => {
  ...
  assert.deepEqual(manifest.files, ["public_research_code/README.md", "scripts/example/sample.py"]);
